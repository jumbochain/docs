...
**Step-5 On the window pop up, open the folder unzipped earlier.**
...
- Go to the [chainlist](https://chainlist.org/?testnets=true&search=protojumbo).

![Chainlist protojumbo listing](./img/chainlist-protojumbo-listing.jpeg)
...
- To get the required network details visit: [ChainList](https://chainlist.org/?testnets=true&search=protojumbo)<br></br>

  ![chain list proto jumbo listing](./img/chainlist-protojumbo-listing.jpeg)

- Here you can get the `chain ID`, `Currency symbol`, `RPC URL`. You can add the network name as `Jumbo Blockchain`.<br></br>

  [Explorer url](https://protojumbo.jumbochain.org/)

  ![alt text](./img/protojumbo-network-details.png)

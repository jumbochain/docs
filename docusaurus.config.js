  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
            ...
            items: [
              {
                ...
                href: 'https://stackoverflow.com/questions/tagged/jumbochain',
              },
              {
                label: 'Discord',
                href: 'https://discordapp.com/invite/jumbochain',
              },
              {
                label: 'X',
        ...
        copyright: `Copyright © ${new Date().getFullYear()} jumbochain. Built with Docusaurus.`,
      },
      prism: {
